...
const RightColumn = tw.div`relative mt-12 lg:mt-0 flex-1 flex h-full flex-col justify-center`;
...
const IllustrationContainer = tw.div`flex h-full justify-center lg:justify-end items-center`;
