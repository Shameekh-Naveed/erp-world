	...
	const defaultCards = [
		{
			...
			description: 'Streamline administrative tasks, from fee management to attendance tracking.',
		},
		{
			imageSrc: ShieldIconImage,
		...
		},
		{
			...
			description: 'Stay connected and manage tasks on the go with our user-friendly mobile app.',
		},
		{
			imageSrc: ShieldIconImage,
