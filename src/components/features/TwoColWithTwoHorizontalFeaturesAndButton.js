...
export default ({
  ...
  description = "At ERP World, we are dedicated to providing exceptional services that meet the diverse needs of educational institutions. Our values guide everything we do, ensuring that we deliver solutions that are innovative, reliable, and user-friendly. We believe in the power of technology to transform education, and we are committed to helping schools achieve their goals through our comprehensive ERP platform.",
